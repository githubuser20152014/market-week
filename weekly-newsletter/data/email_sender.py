  ...
  <div style="max-width:680px;margin:32px auto;background:#ffffff;border-radius:6px;
    ...
    <div style="padding:20px 40px;background:#f9f9f9;border-top:1px solid #e8e8e8;
      ...
      <p style="margin:0 0 6px;">
        ...
        <a href="https://frameworkfoundrymkt.substack.com/" style="color:#555;">frameworkfoundrymkt.substack.com</a>
      </p>
      {data_page_line}
      <p style="margin:0;">
  ...
  <div style="max-width:680px;margin:32px auto;background:#ffffff;border-radius:6px;
    ...
    <div style="padding:32px 40px 24px;">
      ...
      <p style="margin:0 0 0;">
        <a href="https://frameworkfoundrymkt.substack.com/"
...
def send_welcome_email(to_addr: str, gmail_address: str, app_password: str) -> None:
    ...
    plain_body = (
        ...
        "The latest edition is live right now — dive in: https://frameworkfoundrymkt.substack.com/\n\n"
        "To unsubscribe, reply with \"unsubscribe\" in the subject line."
    )
