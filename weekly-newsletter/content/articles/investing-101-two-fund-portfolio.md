---
title: "You probably have 12 funds. You need 2."
series: The Blueprint
issue: 2
date: 2026-03-26
slug: two-fund-portfolio
url: /investing-101/two-fund-portfolio/index.html
tag: Investing 101
tag_class: guide
excerpt: Most people's 401(k)s hold far more funds than they need — and several of them own the same stocks. Here's why a two-fund portfolio covers more ground than it sounds like it should.
...
An **actively managed fund** works the opposite way. A portfolio manager — or a team of them — picks specific securities, makes ongoing judgment calls about what to buy and sell, and tries to outperform the index. They charge for this service. The annual fee, called an **expense ratio**, typically runs between 0.65% and 1.00% of your assets per year for an actively managed US equity fund. Vanguard's [VTI](https://finance.yahoo.com/quote/VTI), a total stock market index fund, charges 0.03%.
...
**The stock side: [VTI](https://finance.yahoo.com/quote/VTI) (or [VTSAX](https://finance.yahoo.com/quote/VTSAX))**

[VTI](https://finance.yahoo.com/quote/VTI) is the ETF version; [VTSAX](https://finance.yahoo.com/quote/VTSAX) is the mutual fund equivalent. They hold the same underlying stocks and produce nearly identical returns. The practical difference: ETFs trade throughout the day like stocks; mutual funds are priced once daily at market close. In a 401(k), you'll usually see the mutual fund version. In an IRA or brokerage account, you can use either.

If your 401(k) doesn't offer [VTI](https://finance.yahoo.com/quote/VTI) or [VTSAX](https://finance.yahoo.com/quote/VTSAX) specifically, look for their equivalents: Fidelity's [FZROX](https://finance.yahoo.com/quote/FZROX) or [FSKAX](https://finance.yahoo.com/quote/FSKAX), Schwab's [SWTSX](https://finance.yahoo.com/quote/SWTSX), or any fund described as a "total stock market index" with an expense ratio under 0.10%. The name and ticker matter less than what it tracks.

**The bond side: [BND](https://finance.yahoo.com/quote/BND) (or [VBTLX](https://finance.yahoo.com/quote/VBTLX))**

[BND](https://finance.yahoo.com/quote/BND) (Vanguard Total Bond Market ETF) or its mutual fund equivalent [VBTLX](https://finance.yahoo.com/quote/VBTLX) holds US government bonds and investment-grade corporate bonds across short, intermediate, and long maturities. It's the ballast in the portfolio — not there to generate high returns, but to behave differently from stocks when the market falls. In 2022, when the S&P 500 dropped 18.1%, [BND](https://finance.yahoo.com/quote/BND) dropped 13.1% — its worst year in decades, as the fastest rate-hiking cycle in 40 years hit bonds hard alongside stocks. It didn't protect the way bonds typically do. But even in that unusual environment, a 70/30 portfolio lost less than an all-stock portfolio. In most recessions and bear markets — 2008, 2001, 2020 — bonds behaved as expected, holding value or rising while stocks fell. 2022 was the anomaly, not the norm.

Again, if your 401(k) doesn't offer [BND](https://finance.yahoo.com/quote/BND) specifically, look for any total bond market index fund with a low expense ratio. That's the function you need.

**Putting it together**

A 70/30 allocation becomes 70% [VTI](https://finance.yahoo.com/quote/VTI) + 30% [BND](https://finance.yahoo.com/quote/BND). A 60/40 allocation becomes 60% [VTI](https://finance.yahoo.com/quote/VTI) + 40% [BND](https://finance.yahoo.com/quote/BND). The allocation you chose in Issue #1 maps directly onto two fund tickers.
...
When Marcus simplifies to [VTI](https://finance.yahoo.com/quote/VTI), he doesn't lose the Apple and Microsoft exposure he already has — they're in [VTI](https://finance.yahoo.com/quote/VTI) too, at their actual market weight. What he loses is the duplication, the hidden overlap, and the extra fees. What he gains is a cleaner, more transparent picture of what he actually owns.
...
1. Write down your target allocation from Issue #1 — for example, 70% stocks, 30% bonds.
2. Identify your total stock market index fund and your bond index fund in the plan's fund menu.
3. Sell everything else and buy the two funds in the target ratio.
