...
*Read this issue on the web: [frameworkfoundry.info/fundaa/2026-04-04/index.html](https://frameworkfoundry.info/fundaa/2026-04-04/index.html)*

---

## LinkedIn

**"The other country will pay." It's been a year since Liberation Day. Here's how tariffs actually work, and why that's still not quite right.**

A tariff is an import tax. When a US company imports goods, US Customs collects a tax at the border. Paid by the US importer. Not the foreign factory. Not the foreign government.

The importer then does what any business does: passes the cost downstream. Wholesaler. Retailer. You.

A year of tariffs. Prices are higher. The promise was that foreign countries would bear the cost. The mechanism doesn't work that way.

The data since Liberation Day makes it concrete. Avocados: $0.87/lb to $1.45/lb average (90% of US supply is Mexican; Mexico got a 25% tariff). Levi's jeans: +$10 a pair, with the company explicitly citing tariffs on its earnings call. A PS5: $499 on Liberation Day, $649 today after two rounds of price hikes. Yale Budget Lab estimated the average US household is paying ~$2,400 more per year. The New York Fed found over 90% of the tariff burden falls on US consumers and businesses, not foreign exporters.

That's not an argument against tariffs. There are genuine strategic cases for them: negotiating leverage, protecting critical industries, national security. But those arguments are different from claiming the foreign side absorbs the cost.

The tariff is collected at the US border from a US company. The cost flows to US consumers. The foreign country retaliates if it feels like it. After Liberation Day, China hit back with 125% tariffs on US goods, which hit American exporters instead.

Trade policy is complicated. "They'll pay" isn't a description of the mechanism.
...
#Tariffs #TradePolicy #PersonalFinance #Economics #FridayFundaa

---

## X (Thread)

**🧵 "The other country will pay for it." It's been a year since Liberation Day. Prices are higher. Here's how tariffs actually work, and who's really writing the cheque. 1/**

---

A tariff is an import tax. When a US company imports goods from abroad, US Customs collects a tax at the border.

Paid by the US importer. Not the factory in China. Not the Vietnamese government. The American company. **2/**

---

What happens next? The importer does what any business does.

Adds the cost to what they charge the wholesaler. Wholesaler adds margin, charges the retailer. Retailer adds margin, charges you.

$25 sneaker + 46% tariff = $36 sneaker. The factory got $25. You paid $36. **3/**

---

"But doesn't the foreign country at least lose business?"

Sometimes. If the tariff is high enough, buyers switch to domestic or lower-tariff suppliers. That hurts their exports.

But losing a customer is different from paying a tax. The tariff revenue doesn't go to them. It comes from you. **4/**

---

The receipts since Liberation Day:

→ Avocados: $0.87/lb to $1.45/lb avg (Mexico: 25% tariff, 90% of US supply)
→ Levi's jeans: +$10/pair, explicitly cited tariffs on their earnings call
→ Nike shoes: +$5-$10 per pair
→ PS5: $499 to $649, two price hikes in one year
→ Average US household: ~$2,400/year more (Yale Budget Lab)

NY Fed: 90%+ of the burden lands on US consumers. Not foreign exporters. **5/**

---

There's also retaliation.

After Liberation Day, China hit back with 125% tariffs on US goods. American exporters now face a wall selling into their biggest overseas market.

The other country didn't absorb the original tariff. They charged back. **6/**

---

None of this means tariffs are always wrong. Real cases exist:
→ Trade negotiation leverage
→ Protecting strategic industries
→ National security

But those arguments aren't the same as "they'll pay for it."

The cost is domestic. The debate is whether the benefit is worth it. **7/**

---

So next time you hear "we're putting tariffs on [country]", run through the chain:

Tariff, US importer pays, cost passed to consumer, foreign country retaliates, US exporters hurt, taxpayers cover it.

The other country didn't pay. **8/**
...
[frameworkfoundry.info/fundaa/2026-04-04/index.html](https://frameworkfoundry.info/fundaa/2026-04-04/index.html)

*For educational purposes only. Not financial advice.* **9/9**
...
"Liberation Day" was a year ago. The tariffs are still here. The promise: the other countries will pay 🎉

Spoiler: they didn't. You did 🙃

Here's the boring truth: a tariff is an import tax collected at the US border. Paid by the US importer. Not the factory in China. Not the Vietnamese government. The *American company* importing the goods pays it, then does what any company does: passes it straight to you.

$25 sneaker + 46% tariff = $36 sneaker. Factory got their $25. US government collected $11. You're out $36. The factory in Hanoi didn't write a cheque. You did 🤷

One year later, here's your shopping list 🧾

Avocados: $0.87 to $1.45/lb (90% of US avocados come from Mexico, which got a 25% tariff - someone did the maths). Bananas: 50¢ to 54¢/lb. Levi's jeans: +$10 a pair (they literally said "tariffs" in their earnings call, bless their honesty). Nike shoes: +$5-$10 per pair. PlayStation 5: $499 to $649 after *two* price hikes in one year. And Yale Budget Lab says the average household is paying ~$2,400 more per year across all the tariffs. This is fine 🔥

"But what about the other country? Don't they suffer?"

Sure, a bit. If prices get high enough, buyers switch suppliers. That hurts their exports.

But losing a customer is different from paying a tax. The tariff money doesn't go to China. It goes to the US Treasury. Via your wallet.

And then they retaliate 😅 China hit back with 125% tariffs on US goods after Liberation Day. American farmers and manufacturers suddenly couldn't sell into their biggest overseas market. The bill circled back. Again.

The tariff is a tax on your shopping cart. The foreign country watches. And charges back.

Full breakdown (with actual numbers) on Substack 👇
https://frameworkfoundry.info/fundaa/2026-04-04/index.html
